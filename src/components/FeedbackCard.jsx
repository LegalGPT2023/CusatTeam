const FeedbackCard = ({ content, name, title, linkedin,img, number }) => (
  <div className="flex justify-start flex-col px-10 py-12 rounded-[20px]  max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
    ...
    <div className="flex flex-row mt-7">
      ...
      <div className="flex flex-col ml-4">
        ...
        <a href={linkedin} className="font-poppins font-normal text-[16px] leading-[24px] text-gradient">LinkedIn</a>
      </div>
    </div>
